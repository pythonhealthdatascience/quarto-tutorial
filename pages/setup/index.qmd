...
[![](github_account.png){fig-alt="Screenshot from GitHub page to create a new account."}](https://github.com/signup)
...
[![It may look a little different from this screenshot if we have changed the repository since writing this page!](quarto-template.png){fig-alt="Screenshot of quarto-template GitHub repository"}](https://github.com/pythonhealthdatascience/quarto-template)
...
![](create_codespace.png){fig-align="center" fig-alt="Screenshot of repository showing Code > Codespaces > Create codespace on main"}
...
![It may look a little different from this screenshot if we have changed the repository since writing this page!](open_codespace.png){fig-alt="Screenshot of the generated GitHub codespace."}
...
![](reopen_codespace.png){fig-align="center" fig-alt="Screenshot of existing Codespace list."}
