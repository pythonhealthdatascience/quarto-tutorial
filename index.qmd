...
::: {.img-float}
![](images/daffodil.png){alt="A yellow daffodil flower with a long green stem, because I thought the page looked boring otherwise" style="float: right; margin: 20px; width: 40%;"}
:::
